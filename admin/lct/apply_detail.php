...
<head>
    ...
    <title><?php echo $object->name;?> - 联创人详细信息</title>
...
<div class="container lcr-detail">
    <div class="lcr-list hidden"><h3><span class="label label-success"><span class="glyphicon glyphicon-education lcr-list-icon"></span> 联创人信息</span></h3></div>
